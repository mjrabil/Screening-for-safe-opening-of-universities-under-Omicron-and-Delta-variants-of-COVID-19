...
#include "full_customization_constants.h"
#include "full_customization.h"
#include <iostream>
#include <iomanip>
#include <array>
...
int main()
{
    ...
    //double TAU_N_S_new_array[] = { 0, 1.0 / (3 * 14.0*15), 1.0 / (3 * 7.0*15), 1.0 / (3 * 3.0*15), 1.0 / (3 * 2.0*15), 1.0 / (3 * 1.0*15) };
    //double TAU_W_S_new_array[] = { 0, 1.0 / (3 * 14.0*15), 1.0 / (3 * 7.0*15), 1.0 / (3 * 3.0*15), 1.0 / (3 * 2.0*15), 1.0 / (3 * 1.0*15) };
    //double TAU_B_S_new_array[] = { 0, 1.0 / (3 * 14.0*15), 1.0 / (3 * 7.0*15), 1.0 / (3 * 3.0*15), 1.0 / (3 * 2.0*15), 1.0 / (3 * 1.0*15) };
                                ...
                                for (int w = 0; (w < TAU_W_S_array_size) && (w <= q); w++)
                                {
                                    ...
                                    // No immunity - Students COMPARTMENTS:  it->current_asymptomatic_N_S
                                                ...
                                                if ((i == TOTAL_PERIODS_NUMBER - 1))    //|| (it->uninfected_N_S <= 0)|| (it->uninfected_N_F <= 0) || (it->uninfected_W_S <= 0) || (it->uninfected_W_F <= 0) || (it->uninfected_B_S <= 0) || (it->uninfected_B_F <= 0))
                                                {
                                                    ...
                                                    if (k == 0 && e == 0 && a == 0 && p == 0 && q == 0 && w == 0 && b == 0 && q_f == 0 && w_f == 0 && b_f == 0)   
                                                    {
